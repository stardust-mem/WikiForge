...
Wiki 是知识编译器，不同层对 LLM 知识的使用有不同策略：

| 页面类型 | LLM 知识使用策略 | 类比 |
|---------|-----------------|------|
| **sources/** | **严格提取** — 只从原文提取和结构化，不添加原文没有的内容 | 论文原文摘要 |
| **entities/** | **多源综合** — 多份文档提到同一实体时合并，事实须有源文档支撑 | 名片夹/百科条目 |
| **concepts/** | **解释与关联** — 基于源文档内容解释概念，可以重新组织结构，建立概念间关联 | 学习笔记 |
| **topics/** | **最高层综合** — 综合所有相关文档形成核心观点，这是 Wiki 最有价值的产出 | 综述报告 |

**底线：具体数据、事实、引言必须来自源文档。不要编造不存在的数据点。**

## 内容质量标准

- **有据可查：** 具体事实必须能追溯到某份源文档
- **结构化：** 使用标题、列表、表格组织信息
- **丰富度：** sources/ 页面完整保留细节；concepts/ 和 topics/ 页面注重解释和综合
